...
class Professor(Account):
    ...
    courseclass_id = db.Column(db.Integer, db.ForeignKey(
        "CourseClasses.id"), nullable=True)
...
class StudentGroup(db.Model):
    ...
    classes = db.relationship(
        'CourseClass', backref='StudentGroups', lazy=True)
...
class CourseClass(db.Model):
    ...
    studentGroups_id = db.Column(
        db.Integer, db.ForeignKey("StudentGroups.id"), nullable=True)
